...
// ==========================================
// ORANG KE-1: DATA, INIT, & LOGIN
// Tanggung Jawab: Struktur data, variabel global, inisialisasi awal, fungsi utilitas, dan sistem login admin.
// ==========================================
...
// FITUR
// ==========================================
// ORANG KE-2: SEWA (BAGIAN 1 - INPUT)
// Tanggung Jawab: Validasi kapasitas transaksi dan input data pelanggan serta pemilihan kamera.
// ==========================================
void prosesSewa() {
    system("cls");
    ...
    // ==========================================
    // ORANG KE-3: SEWA (BAGIAN 2 - HITUNG & BAYAR)
    // Tanggung Jawab: Logika perhitungan diskon, total harga, pembayaran ulang, dan penyimpanan data transaksi.
    // ==========================================
...
// ==========================================
// ORANG KE-4: PENGEMBALIAN & DENDA
// Tanggung Jawab: Menjelaskan logika pengembalian kamera, cek keterlambatan, dan hitung denda.
// ==========================================
...
// ==========================================
// ORANG KE-5: ALGORITMA SORTING
// Tanggung Jawab: Menjelaskan algoritma Bubble Sort untuk mengurutkan kamera berdasarkan harga.
// ==========================================
void sortKamera() {
    system("cls");
...
// ==========================================
// ORANG KE-6: LAPORAN, MENU, & MAIN
// Tanggung Jawab: Menampilkan laporan pendapatan, menu navigasi utama, logout, dan struktur main program.
// ==========================================
